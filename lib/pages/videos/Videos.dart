...
class Videos extends StatelessWidget {
  ...
  final List<Video> items = [
    Video("title1","a nice faire 2","01/01/1970"),
    Video("title2","a nice faire 2","01/01/1970"),
    Video("title3","a nice faire 2","01/01/1970"),
  ];
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute<void>(
                              builder: (context) =>  VideosDetail(video:items[index]),
                            ));
                      },
                      child:Row( children:[
